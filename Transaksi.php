      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
			...
			<!--Tambah Data-->
				<form class="form-horizontal" action="tambah_transaksi.php" method="post">
			<div class="item form-group">
				<label class="col-form-label col-md-3 col-sm-3 label-align">ID_TRANSAKSI</label>
				<div class="col-md-6 col-sm-6 ">
					<input type="text" name="ID_TRANSAKSI" class="form-control" size="4" required>
				</div>
			</div>
			<div class="item form-group">
				<label class="col-form-label col-md-3 col-sm-3 label-align">ID_KASIR</label>
				<div class="col-md-6 col-sm-6">
			...
			<div class="item form-group">
				...
				<div class="col-md-6 col-sm-6">
					<input type="text" name="ID_KUSTOMER" class="form-control" required>
				</div>
			</div>
			<div class="item form-group">
				<label class="col-form-label col-md-3 col-sm-3 label-align">TANGGAL_TRANSAKSI</label>
				<div class="col-md-6 col-sm-6">
			...
			<div class="item form-group">
				<label class="col-form-label col-md-3 col-sm-3 label-align">HARGA_TRANSAKSI</label>
				<div class="col-md-6 col-sm-6">
					<input type="text" name="HARGA_TRANSAKSI" class="form-control" required>
				</div>
			</div>
			<div class="item form-group">
				<label class="col-form-label col-md-3 col-sm-3 label-align">JUMLAH_BARANG</label>
				<div class="col-md-6 col-sm-6">
					<input type="text" name="JMLH_BRG" class="form-control" required>
				</div>
			</div>
			<div class="item form-group">
				<label class="col-form-label col-md-3 col-sm-3 label-align">TOTAL_PEMBAYARAN</label>
				<div class="col-md-6 col-sm-6">
