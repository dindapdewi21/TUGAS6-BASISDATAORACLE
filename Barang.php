        ...
        <div class="container-fluid">
          <div class="row">
			...
			<div class="item form-group">
				<label class="col-form-label col-md-3 col-sm-3 label-align">ID_BARANG</label>
			...
			<div class="item form-group">
				<label class="col-form-label col-md-3 col-sm-3 label-align">NAMA_BARANG</label>
				<div class="col-md-6 col-sm-6">
					<input type="text" name="NAMA_BRG" class="form-control" required>
				</div>
			</div>
			<div class="item form-group">
				<label class="col-form-label col-md-3 col-sm-3 label-align">JENIS_BARANG</label>
				<div class="col-md-6 col-sm-6">
					<input type="text" name="JENIS_BRG" class="form-control" required>
				</div>
			<div class="item form-group">
				<label class="col-form-label col-md-3 col-sm-3 label-align">HARGA_BARANG</label>
				<div class="col-md-6 col-sm-6">
					<input type="text" name="HARGA_BRG" class="form-control" required>
				</div>
			</div>
			<div class="item form-group">
				<label class="col-form-label col-md-3 col-sm-3 label-align">JUMLAH_STOK</label>
				<div class="col-md-6 col-sm-6">
					<input type="text" name="JMLH_STOK" class="form-control" required>
				</div>
			</div>
			<div class="item form-group">
				<label class="col-form-label col-md-3 col-sm-3 label-align">TANGGAL_KADALUARSA</label>
				<div class="col-md-6 col-sm-6">
					<input type="text" name="TGL_KADALUARSA" class="form-control" required>
				</div>
			</div>
			<div class="item form-group">
